...
SECRET_KEY = 'django-insecure-#=jqwdn7(dhedqe5lrt9($pok@6_7c=0_vlu!t-dy$+o)ydhrw'
...
DJOSER = {
    ...
    'SERIALIZES' :{
        ...
        'user':'learning.serializers.UserCreateSerializer',
...
AUTH_USER_MODEL = 'learning.UserAccount' 